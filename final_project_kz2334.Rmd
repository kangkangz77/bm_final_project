...
selected 11 predictors(excldue income and 3 education related vars)
```{r}
cancer_data_dff1 = cancer_data_df %>% 
...
leaps(x = cancer_data_dfff1[,2:11], y = cancer_data_dfff1[,1], nbest=2, method="Cp")


# Printing the 2 best models of each size, using the adjusted R^2 criterion:
leaps(x = cancer_data_dfff1[,2:12], y = cancer_data_dfff1[,1], nbest=2, method="adjr2")
